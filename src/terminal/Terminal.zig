...
pub fn markSemanticPrompt(self: *Terminal, p: SemanticPrompt) void {
    ...
    // also immediately update the current cell and row to reflect the new
    ...
    switch (p) {
        .prompt, .prompt_continuation => {
            ...
            self.screen.cursor.page_row.semantic_prompt = true;
        },
        .input => {
        ...
        .command => {
            ...
            //
            // This should be a very rare operation in practice and this logic
            // exists primarily for guaranteeing correctness.
            // if (self.screen.cursor.page_row.semantic_prompt) recheck: {
            //     log.debug("rechecking semantic state y={}", .{self.cursor.y});
            ...
            //     self.screen.cursor.page_row.semantic_prompt = false;
            // }
        },
    }
}
        ...
        .complete => {
            ...
            if (self.active_screen == .primary) at_prompt: {
                ...
                while (it.next()) |p| {
                    ...
                    if (row.semantic_prompt) break :at_prompt;
