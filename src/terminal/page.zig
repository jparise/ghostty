...
pub const Page = struct {
    ...
    pub fn clearCells(
        ...
        if (row.semantic_prompt_or_input) semantic_prompt: {
...
pub const Row = packed struct(u64) {
    ...
    /// NEW: Replaces the semantic_prompt enum (and should take its name)
    ///
    /// True if any of the cells in this row are marked as a semantic
    /// prompt or input.
    semantic_prompt_or_input: bool = false,

    /// OLD: To be removed in favor of the semantic_prompt_or_input flag
    ///
